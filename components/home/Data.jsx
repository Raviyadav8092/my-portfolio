...
const Data = () => {
    return (
        ...
        <div className="home__data">
            <h1 className="home__title">Ravi Yadav
            ...
            <p className="home__description">I'm creative developer
                from Lovely Professional University, and I'm very passionate and dedicated
                to my work.</p>
